...
function relaventExperience() {
    ...
    if (scores.caringHost > scores.emotionalTurmoil && scores.caringHost > scores.financialBurdens) {
        ...
        return ("<p>Financial Burdens</p><ul><li>Divorce brings financial challenges such as living expenses, legal fees, and reduced income.</li><li>Many feel the strain of stricter budgeting and handling new financial responsibilities.</li><li>Financial burdens may include setting up a new household, child support, alimony, and asset division.</li><li>Fear of an uncertain financial future can deter people from leaving an unhappy marriage.</li></ul>")
    }
}
